...
<style>
  ...
  .up{ left: 40px; background: url("./assets/carousel_left.png"); background-size: 100% 100%;}
  .next{ left: auto; right:40px; background: url("./assets/carousel_right.png"); background-size: 100% 100%;}
  .close{ position: absolute; top: 40px; right: 48px; width: 32px; height: 32px; cursor: pointer; border-radius: 50%; background: url("./assets/carousel_close.png"); background-size: 100% 100%;}
  ...
  .tool_box div.tool1{ background: url("./assets/carousel_icon1.png"); background-size: 100% 100%;}
  .tool_box div.tool2{ background: url("./assets/carousel_icon2.png"); background-size: 100% 100%;}
  .tool_box div.tool3{ background: url("./assets/carousel_icon3.png"); background-size: 100% 100%;}
  .tool_box div.tool4{ background: url("./assets/carousel_icon4.png"); background-size: 100% 100%;}
