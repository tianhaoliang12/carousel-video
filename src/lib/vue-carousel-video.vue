...
<style>
  ...
  .vcv-carousel  .vcv-carousel__up{ left: 40px; background: url("http://storage.jd.local/electron/carousel_left.png"); background-size: 100% 100%;}
  .vcv-carousel  .vcv-carousel__next{ left: auto; right:40px; background: url("http://storage.jd.local/electron/carousel_right.png"); background-size: 100% 100%;}
  .vcv-carousel  .vcv-carousel__close{ position: absolute; top: 40px; right: 48px; width: 32px; height: 32px; cursor: pointer; border-radius: 50%; background: url("http://storage.jd.local/electron/carousel_close.png"); background-size: 100% 100%;}
  ...
  .vcv-carousel  .vcv-carousel__tool_box div.vcv-carousel__tool1{ background: url("http://storage.jd.local/electron/carousel_icon1.png"); background-size: 100% 100%;}
  .vcv-carousel  .vcv-carousel__tool_box div.vcv-carousel__tool2{ background: url("http://storage.jd.local/electron/carousel_icon2.png"); background-size: 100% 100%;}
  .vcv-carousel  .vcv-carousel__tool_box div.vcv-carousel__tool3{ background: url("http://storage.jd.local/electron/carousel_icon3.png"); background-size: 100% 100%;}
  .vcv-carousel  .vcv-carousel__tool_box div.vcv-carousel__tool4{ background: url("http://storage.jd.local/electron/carousel_icon4.png"); background-size: 100% 100%;}
